...
func _erzeuge_aufgabe() -> void:
	var zufallswert : int = 8 #randi() %2 +7
	...
	if rng == 0:
		...
		zufall_handwert_links = randi() %8 +1
...
func _aufgabe_anzeigen(zahl : int) -> void:
	...
	match zahl:
		0:
			...
			$AufgabenPanel/PanelUnten/Kugeln/Kugel6.visible = false
			$AufgabenPanel/PanelUnten/Kugeln/Kugel7.visible = false
			$AufgabenPanel/PanelUnten/Kugeln/Kugel8.visible = false
		1:
			$AufgabenPanel/PanelUnten/Kugeln/Kugel1.visible = false
			$AufgabenPanel/PanelUnten/Kugeln/Kugel2.visible = false
			$AufgabenPanel/PanelUnten/Kugeln/Kugel3.visible = false
		...
		3:
			...
			$AufgabenPanel/PanelUnten/Kugeln/Kugel4.position.x += 62
			$AufgabenPanel/PanelUnten/Kugeln/Kugel5.position.x += 62
			$AufgabenPanel/PanelUnten/Kugeln/Kugel6.visible = false
			$AufgabenPanel/PanelUnten/Kugeln/Kugel7.visible = false
			$AufgabenPanel/PanelUnten/Kugeln/Kugel8.visible = false
		4:
		...
		5:
			...
			$AufgabenPanel/PanelUnten/Kugeln/Kugel4.position.x += 62
			$AufgabenPanel/PanelUnten/Kugeln/Kugel5.position.x += 62
			$AufgabenPanel/PanelUnten/Kugeln/Kugel6.position.x += 62
			$AufgabenPanel/PanelUnten/Kugeln/Kugel7.visible = false
			$AufgabenPanel/PanelUnten/Kugeln/Kugel8.visible = false
		6:
			$AufgabenPanel/PanelUnten/Kugeln/Kugel1.visible = false
		...
		7:
			...
			$AufgabenPanel/PanelUnten/Kugeln/Kugel5.position.x += 62
			$AufgabenPanel/PanelUnten/Kugeln/Kugel6.position.x += 62
			$AufgabenPanel/PanelUnten/Kugeln/Kugel7.position.x += 62
			$AufgabenPanel/PanelUnten/Kugeln/Kugel8.visible = false
