...
func _erzeuge_aufgabe() -> void:
	...
	if rng == 0:
		...
		zufall_handwert_links = randi() %9 +1
...
func _aufgabe_anzeigen(zahl : int) -> void:
	...
	match zahl:
		9:
			$AufgabenPanel/PanelUnten/Kugeln/Kugel1.position.x += 53
			$AufgabenPanel/PanelUnten/Kugeln/Kugel2.position.x += 53
			$AufgabenPanel/PanelUnten/Kugeln/Kugel3.position.x += 53
			$AufgabenPanel/PanelUnten/Kugeln/Kugel4.position.x += 53
			$AufgabenPanel/PanelUnten/Kugeln/Kugel5.position.x += 53
			$AufgabenPanel/PanelUnten/Kugeln/Kugel6.position.x += 53
			$AufgabenPanel/PanelUnten/Kugeln/Kugel7.position.x += 53
			$AufgabenPanel/PanelUnten/Kugeln/Kugel8.position.x += 53
			$AufgabenPanel/PanelUnten/Kugeln/Kugel9.position.x += 53
			$AufgabenPanel/PanelUnten/Kugeln/Kugel10.visible = false
...
func _hand_anzeigen(zahl : int) -> void:
	match zahl:
		0:
			...
			$AufgabenPanel/PanelUntenLinks/Kugel6.visible = false
			$AufgabenPanel/PanelUntenLinks/Kugel7.visible = false
			$AufgabenPanel/PanelUntenLinks/Kugel8.visible = false
			$AufgabenPanel/PanelUntenLinks/Kugel9.visible = false
			$AufgabenPanel/PanelUntenLinks/Kugel10.visible = false
		1:
			$AufgabenPanel/PanelUntenLinks/Kugel1.visible = false
			$AufgabenPanel/PanelUntenLinks/Kugel2.visible = false
			$AufgabenPanel/PanelUntenLinks/Kugel4.visible = false
